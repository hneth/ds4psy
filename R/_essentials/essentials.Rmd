...
- position: dodge vs. stacked
- statistics: `count` vs. `prop` vs. `identity`
- error bars 
...
- colors: can be set with geoms (variable when inside `aes()` or fixed outside), choosing or designing specific color scales;  
