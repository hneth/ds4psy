...
This file contains **essential commands** from the chapters of [r4ds](http://r4ds.had.co.nz). 
...
Create an R script (`.R`) or an R-Markdown file (`.Rmd`) and load the R packages of the `tidyverse`. 
...
## (i) Bonus task:
# Turn ir_long back into original wide format using tidyr::spread -----
# ir_long
...
## See (f) above for additional mutate step: 
## mutate(id = rep(1:50, 3)) %>%   # add a unique id to each plant [to enable (i) below]
