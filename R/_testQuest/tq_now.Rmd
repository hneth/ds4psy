...
**`r nr<-nr+1; nr`.** Let's explore the `dplyr::starwars` universe within the tidyverse. 

Please answer the following questions by using pipes of basic `dplyr` commands (i.e., arranging, filtering, selecting, grouping, counting, summarizing).
...
Commands to create and convert to tibbles are included in tasks to other chapters. 
