...
- Include a header that contains your _name_, _student ID_, this _course_, and today's _date_.

- Load the R packages of the `tidyverse`. 

- Structure your file by clearly marking the current task (e.g., `# Task 1: -----`) and subtask (e.g., `# (a):`).

- When asked for numbers or interpretations, include short answers as comments in your script. However, when asked for quantitative summaries (e.g., descriptive statistics on a dataset) simply print them to your console (or save them as an object).
