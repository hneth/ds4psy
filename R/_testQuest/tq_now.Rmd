...
**`r nr<-nr+1; nr`.** Let's tackle the universe with the tidyverse by uncovering some facts about the `dplyr::starwars` dataset. Answer the following questions by using pipes of basic `dplyr` commands (i.e., arranging, filtering, selecting, grouping, counting, summarizing). 
...
This file currently contains about **`r nr` tasks** and a total of **`r pt` points**.  
