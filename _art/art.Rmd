...
<img src = "./../pix/logo/logo_4grau3_white.png" alt = "ds4psy" style = "width: 100px; float: right; border:0;"/>
</a>
...
<img src = "./../pix/logo/logo_4grau3_white.png"  alt = "ds4psy" style = "border:0;"/>

<img src = "./../pix/logo/logo_4grau3_Swhite.png" alt = "ds4psy" style = "border:0;"/>

<img src = "./../pix/logo/logo_4grau3_Sblack.png" alt = "ds4psy" style = "border:0;"/>

<img src = "./../pix/logo/logo_4black_Swhite.png" alt = "ds4psy" style = "border:0;"/>

<img src = "./../pix/logo/logo_4black_Sblack.png" alt = "ds4psy" style = "border:0;"/>
...
Corresponding logo (see code in project `rtwrk`):
...
# Table: 
tb <- tibble(x = rep(1:n_y, times = n_x),
...
# Save current plot: 
plot_name <- paste0("./../pix/tiles/row_sort_", n_x, "_brd.png")
ggsave(plot_name, width = plot_size, height = plot_size, units = c("cm"), dpi = 300)
...
# Save current plot: 
plot_name <- paste0("./../pix/tiles/row_rand_", n_x, "_brd.png")
ggsave(plot_name, width = plot_size, height = plot_size, units = c("cm"), dpi = 300)
...
# Save current plot: 
plot_name <- paste0("./../pix/tiles/pie_sort_", n_x, "_brd.png")
ggsave(plot_name, width = plot_size, height = plot_size, units = c("cm"), dpi = 300)
...
# Save current plot: 
plot_name <- paste0("./../pix/tiles/pie_rand_", n_x, "_brd.png")
ggsave(plot_name, width = plot_size, height = plot_size, units = c("cm"), dpi = 300)
...
# Save current plot: 
plot_name <- paste0("./../pix/tiles/col_sort_", n_x, "_brd.png")
ggsave(plot_name, width = plot_size, height = plot_size, units = c("cm"), dpi = 300)
...
# Save current plot: 
plot_name <- paste0("./../pix/tiles/col_rand_", n_x, "_brd.png")
ggsave(plot_name, width = plot_size, height = plot_size, units = c("cm"), dpi = 300)
...
# Save current plot: 
plot_name <- paste0("./../pix/tiles/tar_sort_", n_x, "_brd.png")
ggsave(plot_name, width = plot_size, height = plot_size, units = c("cm"), dpi = 300)
...
# Save current plot: 
plot_name <- paste0("./../pix/tiles/tar_rand_", n_x, "_brd.png")
ggsave(plot_name, width = plot_size, height = plot_size, units = c("cm"), dpi = 300)
```
...
<img src = "./../pix/tiles/row_sort_4_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/col_sort_4_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/pie_sort_4_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/tar_sort_4_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>


<img src = "./../pix/tiles/row_sort_8_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/col_sort_8_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/pie_sort_8_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/tar_sort_8_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>

Random versions:

<img src = "./../pix/tiles/row_rand_4_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/col_rand_4_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/pie_rand_4_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/tar_rand_4_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>

<img src = "./../pix/tiles/row_rand_8_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/col_rand_8_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/pie_rand_8_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
<img src = "./../pix/tiles/tar_rand_8_brd.png" alt = "ds4psy" style = "height: 120px; border:0;"/>
...
toc <- tribble(
  ~nr, ~tp,                 ~ctr,   
  0,  "Introduction",          2,  
  1, 	"R basics",              10,  # was: "Basic R concepts and commands",
...
# Save plot:
cur_name <- paste0(pic_path, "toc/", "toc_centrality", ".png")
...
nr_session <- 1     # specific session nr
...
<img src = "./../pix/circ/circ_4a.png" style = "width: 800px; border:1;"/>

<img src = "./../pix/circ/circ_4b.png" style = "width: 800px; border:1;"/>

<img src = "./../pix/circ/circ_4e.png" style = "width: 800px; border:1;"/>
...
<img src = "./../pix/circ/circ_8_a1.0.png" style = "width: 800px; border:1;"/>

<img src = "./../pix/circ/circ_8_a.50_mixd.png" style = "width: 800px; border:1;"/>

<img src = "./../pix/circ/circ_8_a.38.png" style = "width: 800px; border:1;"/>
...
<img src = "./../pix/art/pi_10k_w2.png" style = "width: 1000px; float: right; border:0;"/>
