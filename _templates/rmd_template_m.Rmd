...
This is the _medium_ R Markdown template for our course.  A more extensive introduction is available [here](http://Rpository.com/down/temp/Rmarkdown_basics.html) (and the corresponding `.Rmd` source [here](http://Rpository.com/down/temp/Rmarkdown_basics.Rmd)).
...
```{r install_load, echo = FALSE, eval = TRUE}
