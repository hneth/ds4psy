...
setwd("~/Desktop/stuff/Dropbox/_code/R/_teachR/ds4psy/R/_testQuest/02_fe") # set to current directory
...
```{r plantGrowth, echo = FALSE, eval = FALSE, fig.show = "hold"}
...
```{r weather_transformations, echo = FALSE, eval = FALSE}
...
```{r numeracy_solution, echo = FALSE, eval = FALSE}
...
```{r your_data_solution, echo = FALSE, eval = FALSE}
## Your data source: 
