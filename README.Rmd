...
This R package provides datasets and functions used in the [ds4psy](https://bookdown.org/hneth/ds4psy/) and [i2ds](https://bookdown.org/hneth/i2ds/) books and corresponding course curricula. 
...
* PSY-16620, at the [University of Konstanz](https://www.uni-konstanz.de) is taught by [Hansjörg Neth](https://www.spds.uni-konstanz.de/hans-neth), [Social Psychology and Decision Sciences](https://www.spds.uni-konstanz.de), office\ D507   
...
This package and the corresponding books and courses provide an introduction to data science that is tailored to the needs of students in psychology, but is also suitable for students of the humanities and other biological or social sciences. 
...
- A current version of both books are available at <https://bookdown.org/hneth/ds4psy/> and <https://bookdown.org/hneth/i2ds/>. 
...
- A version of [Data science for psychologists](https://bookdown.org/hneth/ds4psy/) is available online at <https://bookdown.org/hneth/ds4psy/>.  
