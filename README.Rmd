...
* PSY-15150, at the [University of Konstanz](https://www.uni-konstanz.de) by [Hansjörg Neth](https://www.spds.uni-konstanz.de/hans-neth)  (<h.neth@uni.kn>, [SPDS](https://www.spds.uni-konstanz.de), office D507).  
...
- [R Studio](https://www.rstudio.com/) is an integrated development environment (IDE) for R.
...
- [RStudio](https://www.rstudio.com/) [IDE](https://www.rstudio.com/products/rstudio/), [R\ Markdown](https://rmarkdown.rstudio.com/), and various [cheat sheets](https://www.rstudio.com/resources/cheatsheets/) 
