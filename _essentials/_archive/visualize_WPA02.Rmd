...
```{r bar_plot_error_bar, echo = TRUE, eval = TRUE, fig.width = 5, fig.height = 4}
## Create data to plot: ----- 
n_cat <- 6
...
```{r ggplot_scatter_basic, echo = FALSE, eval = FALSE}
## Data:
# ggplot2::mpg
...
```{r ggplot_scatter_overplotting, echo = FALSE, eval = FALSE}
...
```{r ggplot_scatter_labs_theme, echo = FALSE, eval = FALSE}
...
```{r ggplot_scatter_group_by_class, echo = FALSE, eval = FALSE}
...
```{r ex_freqpoly_solution, echo = FALSE, eval = FALSE}
# Solution: ----- 
...
# => Both geoms require a y-aesthetic (here: the count of cars per x-value).
```
...
```{r ex3_bar_plot_count_ex, echo = FALSE, eval = FALSE}
...
```{r ex4_chickWeight_line_plot, echo = FALSE, eval = FALSE}
...
```{r ex4_chickWeight_bar_plot, echo = FALSE, eval = TRUE}
...
```{r ex5_histograms, echo = FALSE, eval = FALSE}
...
```{r ex5_bar_plots, echo = FALSE, eval = FALSE}
