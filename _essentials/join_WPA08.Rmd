...
```{r write_and_re-read_t3_t4, echo = FALSE, eval = FALSE}
# Save and store t3 and 4t online (at "http://rpository.com/ds4psy/data/"):

# 1. Save tables:
write_csv(t3, "../data/t3.csv")
write_csv(t4, "../data/t4.csv")

# 2. Re-read tables (from local /data source):
t3b <- read_csv("../data/t3.csv")
t4b <- read_csv("../data/t4.csv")

# 3. Re-read tables (from online source):
t3b <- read_csv(file = "http://rpository.com/ds4psy/data/t3.csv")
t4b <- read_csv(file = "http://rpository.com/ds4psy/data/t4.csv")

# 4. Verify identity (of above with re-read online data):
all.equal(t3, t3b) 
all.equal(t4, t4b)
```
...
Here are the exercises of WPA08.
