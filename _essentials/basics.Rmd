...
1. This data set contains `r n_total` individuals.
...
- [YaRrr! The Pirate’s Guide to R](https://bookdown.org/ndphillips/YaRrr/) provides a more detailed and more entertaining introduction to R.  
- See [Rpository.com/learnR/](http://rpository.com/learnr/) for corresponding exercises (with solutions)
- R [manuals](https://cran.r-project.org/manuals.html) and [other documentation](www.r-project.org/other-docs.html).  
