...
(Hint: Consider using `sample` for first creating 3 separate vectors -- one for each sub-group -- and then creating an longer vector that combines the 3 subgroups.)
