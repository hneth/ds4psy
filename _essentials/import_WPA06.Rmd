---
title: "Importing files, with WPA06 (ds4psy)"
...
```{r ex4_file_paths, echo = FALSE, eval = TRUE}
...
```{r ex4_ex1, echo = FALSE, eval = FALSE}
...
```{r ex4_ex2, echo = FALSE, eval = FALSE}
...
```{r ex4_ex3, echo = FALSE, eval = FALSE}
# With read.csv
...
```{r ex4_ex4, echo = FALSE, eval = FALSE}
# With read.csv:
d_1 <- read.csv(ex4)
...
```{r ex4_add, echo = FALSE, eval = FALSE}
# with read.csv:
...
```{r ex6_p_info_1, echo = FALSE, eval = FALSE}
# Load data:
p_info <- read_csv(file = "http://rpository.com/ds4psy/data/posPsy_participants.csv")  # online
...
```{r ex6_p_info_2, echo = FALSE, eval = FALSE}
...
```{r ex6_p_info_3, echo = FALSE, eval = FALSE}
# Mean age by intervention:
p_info_2 %>% 
  group_by(intervention) %>% 
  summarise(n = n(),
