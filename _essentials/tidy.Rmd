...
```{r ex_create_t_1, echo = FALSE, eval = TRUE}
...
```{r ex_create_t_2, echo = FALSE, eval = TRUE}
# t_2: ---- 
...
```{r ex_create_t_3, eval = TRUE, echo = FALSE}
...
```{r ex_create_t_4, eval = TRUE, echo = FALSE}
...
t_2_tidy$age    <- as.integer(t_2_tidy$age)
