...
Use the `iris` data, turn into tibble, and conduct an EDA on it.

## Exercise X: 

#### Accounting

Ada, Brian, and Cecil are sharing a house and keep a record of the items that each of them purchased for the household.  
