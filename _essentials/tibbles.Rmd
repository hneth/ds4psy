...
- What are the variables and what are the observations here? 

- Enter this data into a tibble `dec_1` and then answer the following questions (by using `dplyr` to create tables that contain the answer):
...
buy_by_day %>% arrange(desc(sm_pay))
