...
**Answer:** The completion rate in the different intervention groups varies from 14.9% (for Intervention 3: “Gratitude visit”) to 31.2% (Intervention 2: “Three good things”). The control condition (Intervention 4: “Recording early memories”) had an intermediate completion rate of 27.4%.   
...
```{r ex3_income_counts, echo = TRUE, eval = FALSE}
## Data: 
df <- posPsy_wide
# df
...
2. Compare means from Occasion 0 to 5


3. Compare means from Occasion 0 to 1.
