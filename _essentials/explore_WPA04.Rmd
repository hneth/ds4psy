---
title: "Exploring data, WPA04 (EDA, ds4psy)"
...
```{r ex4_main_results_1, echo = FALSE, eval = FALSE}
# Data:
df <- AHI_CESD
dim(df)  # 992 50
# df
...
```{r ex5_1_AHI_check, echo = FALSE, eval = FALSE} 
## Data:
## 2. Original DVs in long format:
# AHI_CESD <- read_csv(file = "http://rpository.com/ds4psy/data/posPsy_AHI_CESD.csv")
...
```{r ex5_2_CESD_fail, echo = FALSE, eval = FALSE} 
## Data:
df <- AHI_CESD
dim(df)  # 992 x 50
...
```{r ex5_3_CESD_correct, echo = FALSE, eval = FALSE} 
