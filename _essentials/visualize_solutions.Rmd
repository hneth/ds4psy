...
**Dealing with overplotting:** A common issue with scatterplots is so-called _overplotting_: Multiple points appear on the same position. 
...
See [Chapter 3: Data visualization](http://r4ds.had.co.nz/data-visualisation.html)) and [Chapter 7: Exploratory data analysis (EDA)](http://r4ds.had.co.nz/exploratory-data-analysis.html) and complete their exercises. 
