---
title: "Functions, with WPA09 (ds4psy)"
...
- format your functions so that they are easy to read (i.e., use blank lines between different parts and automatic indentation), and 
...
Here are the exercises of WPA09, which are to be submitted on [Ilias](https://ilias.uni-konstanz.de/ilias/goto_ilias_uni_crs_809936.html) by Thursday, Jan. 31, 2019.
...
Test each of your resulting functions with appropriate function calls. 
...
- To really understand how functions are evaluated and used in R, [Advanced R](http://adv-r.had.co.nz/) devotes chapters on [Functions](http://adv-r.had.co.nz/Functions.html) and [Environments](http://adv-r.had.co.nz/Environments.html), and 
[Functional programming](http://adv-r.had.co.nz/Functional-programming.html).

- The `dplyr` [vignette on programming](https://dplyr.tidyverse.org/articles/programming.html) (see `vignette("programming")`) explains some specifics about writing tidyverse functions.
