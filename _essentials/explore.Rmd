...
To use **R Markdown**, create a corresponding file and save it with the `.Rmd` extension (e.g., by selecting `File > New File > R Markdown`). 
...
- **Principle 2:** Start with a clean slate and explicitly load all data and all packages required.
...
### Mixing geoms with multiple aesthetics
...
1. Structure and comment your analysis.

2. Start with a clean slate and explicitly load all data and all packages required.
