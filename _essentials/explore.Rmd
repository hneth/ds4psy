...
Working through the above examples should have provided you with a pretty clear picture of the data in `AHI_CESD`. 
However, we haven't touched the data contained in `posPsy_wide` yet. 
Given that this is described as a modified and corrected version of `AHI_CESD`, we should not expect to find completely different results in it. 
So let's use `posPsy_wide` to exercise and improve our skills in EDA. 
