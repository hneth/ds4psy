...
- **Principle 4:** Know (the dimensions of) your data and (types of) your variables. 

In the following, we first inspect the original data file, which we read in from <http://rpository.com/ds4psy/data/posPsy_AHI_CESD.csv> above: 
