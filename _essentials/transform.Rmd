...
Based on this background, we examine some essential commands of the **dplyr** package in the context of examples. 
These commands allow us to select cases and variables out of rectangular datasets and compute summary statistics over variables or groups of values. Overall, this allows us to get a quantitative overview of data that psychologists often refer to as _descriptive statistics_. However, **dplyr** extends beyond this introduction -- and will appear again later (e.g., in [Chapter 13: Relational data](https://r4ds.had.co.nz/relational-data.html)). 


# Essential commands and examples 

Data transformation includes re-arranging, selecting, changing, and aggregating data. 

## Overview

When we have data in the form of a tibble or data frame, `dplyr` provides a range of simple tools to transform this data. 
Six essential **dplyr** commands are: 
