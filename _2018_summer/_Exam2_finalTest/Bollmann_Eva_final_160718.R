...
#when reading the exam, I greatly advise to use "Shipt+ O" because I structures the exam like that.
...
# Answer: 
# -> There is a decrease in height from the youngest to the olderst cohort, but non of those differences of height between any cohorts are discriptively (no test for significance)
#_________________________________________________
