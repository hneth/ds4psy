...
## Use 2 steps:
## - Introduce a variable that determines whether someone had their bday this year.
## - Adjust age by 0 or 1 depending on this variable.
...
pt <- 28  # good analysis and graphs, minor gaps.
...
## - avoid "." within variables
## - avoid/replace Umlauts in data
...
tribble(
  ...
  #-----------|---|-------------|----------|----------|---|---|---|        
  "Silvio Heinevetter", 12,  21.10.1984,  "TW", "F?chse Berlin",  176,  2,  0,  
  ...
  "Fabian Wiede", 10 ,8.02.1994,  "RR", "F?chse Berlin",  62,  117,  1.9  ,
  "Hendrik Pekeler", 13 , 2.07.1991,  "KR" ,  "Rhein-Neckar L?wen",  80  124  1.6,  
  "Steffen Weinhold", 17,  19.07.1986,  "RR", "THW Kiel",  111,  279 , 2.5,  
  "Tim Kneule",18,   18.08.1986,  "RM" , "Frisch Auf G?ppingen" ,  30  ,44 , 1.5  ,
  "Marian Michalczik",22,  1.02.1997,  "RL" ,"GWD Minden" , 8 , 6,  0.8  ,
  "Patrick Groetzki",24,  4.07.1989,  "RA" ,  "Rhein-Neckar L?wen",  128,  345 , 2.7  ,
  "Kai H?fner", 25,  10.07.1989,  "RR", "TSV Hannover-Burgdorf",  68,  149,  2.2,  
  "Evgeni Pevnov", 28, 13.02.1989  ,"KR"  ,"TSV Hannover-Burgdorf",  18,  11 , 0.6 , 
  "Tim Hornke", 29, 4.08.1990,  "RA",  "TBV Lemgo", 17,  40,  2.4 , 
  "Julius K?hn", 35,  1.04.1993,  "RL",  "MT Melsungen",48,  155,  3.2,  
  "Matthias Musche", 37,  18.07.1992,  "LA",  "SC Magdeburg",  26,  41,  1.6 , 
  "Fabian B?hm", 38, 24.06.1989,  "RL",   "TSV Hannover-Burgdorf",  11,  13,  1.2,  
...
# (e) how many players play in the team "Rhein-Neckar L?wen" (Verein)?
owndata%>%
  group_by(Verein)%>%
  count%>%
...
# (h) Zusammenhang Jahrgang + L?nderspiele
...
#?ltere Spieler haben tendenziell mehr Spielerfahrung (mehr L?nderspiele),
...
pt <- 4  # good efforts, but beware of German data (Umlauts etc.).
