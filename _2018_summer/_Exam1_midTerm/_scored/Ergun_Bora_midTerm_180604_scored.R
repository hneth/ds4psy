...
## Name: Bora Erg?n | Student ID: 126014325137
## 2018 06 04
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ##
...
long_end %>% 
  ggplot(aes(x = day, y = stock_prices, color = stock, shape = stock)) +
  geom_point(size = 4) + 
...
# Total of 24 points (out of 50).
# Grade: 2.0.  Good, but with room to improve.  
